...
import com.jhworks.imageselect.utils.FileUtils
import com.jhworks.imageselect.utils.ImageHeaderParser
import java.io.File
...
class BitmapCropTask(
    ...
    private var mCropRect = imageState.cropRect
    private var mCurrentImageRect = imageState.currentImageRect
    ...
    private var mCompressFormat = cropParameters.compressFormat
    private var mCompressQuality = cropParameters.compressQuality
    private var mImageInputPath = cropParameters.imageInputPath
    private var mImageOutputPath = cropParameters.imageOutputPath
    private var mExifInfo = cropParameters.exifInfo
